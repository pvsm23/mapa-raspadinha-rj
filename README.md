...
- **Login com feedback mais claro**: o botão muda pro texto "Entrando..."/"Criando conta..." e desabilita os campos durante o carregamento (além do spinner), e mostra um aviso se passar de 8s sem resposta ("verifique sua internet"). Se o login parecer "travado sem nada acontecer" mesmo assim, o mais provável é estar testando uma versão desatualizada em cache — força um refresh sem cache (Ctrl+Shift+R) ou reinstale o PWA.
